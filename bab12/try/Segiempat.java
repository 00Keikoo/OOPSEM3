...
public class Segiempat{
	...
	void cetakSegiempat(){
		System.out.println("Segiempat: <" +x1 + ", " + y1);
		System.out.println(", " +x2 +", "+y2 +">");
	}

	public static void main(String[] arguments){
		Segiempat rect = new Segiempat();
		System.out.println("Buat segiempat dengan kordinat (25, 25) dan (50, 50)");
		...
		rect.cetakSegiempat();
		System.out.println();
		System.out.println("Buat segiempat dengan 1 point (10,10), koordinat (50,50)");
